...
def replicability(seed=None):
    ...
    torch.cuda.manual_seed(
        seed
    )  # Sets the seed for generating random numbers for the current GPU. It’s safe to call this function if CUDA is not available; in that case, it is silently ignored.insufficient to get determinism
    ...
    def __init__(self, dataset):
        if dataset == "WISE":
            ...
            self.action2id = {
                ...
                "Answer-fact-link": 14,
                "Answer-fact-text": 15,
                "Answer-fact-steps": 16,
                "Answer-open-list": 17,
                "Answer-open-link": 18,
                "Answer-open-text": 19,
                "Answer-open-steps": 20,
                "Answer-opinion-text": 21,
                "Answer-opinion-list": 22,
                "Answer-opinion-link": 23,
                "Unknown": 24,
                "Chitchat": 25,
            }  # 26
            ...
            self.id2action = {
                ...
                14: "Answer-fact-link",
                15: "Answer-fact-text",
                16: "Answer-fact-steps",
                17: "Answer-open-list",
                18: "Answer-open-link",
                19: "Answer-open-text",
                20: "Answer-open-steps",
                21: "Answer-opinion-text",
                22: "Answer-opinion-list",
                23: "Answer-opinion-link",
                24: "Unknown",
                25: "Chitchat",
            }  # 26
